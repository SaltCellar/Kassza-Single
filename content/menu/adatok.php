...
<div class="keret" style="margin: 100px auto; padding-bottom: 90px;">
    ...
    <button id="button_mutat" type="button" style="margin-top: 20px;" class="btn btn-dark pull-right">Mutat</button>
