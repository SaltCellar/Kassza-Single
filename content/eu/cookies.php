<?php
    setTitle('Süti („cookie”) Információ');
?>
<div class="keret" style="margin: 100px auto;">

    <div class="splitRow" style="margin-bottom: 60px;">
        <h2>Süti („cookie”)</h2>
    ...
    <h2>1. „Sütik” használatának szabályzata</h2>
    <p>Ez a szabályzat a jelen böngészett weboldal „sütijeire” vonatkozik.</p>
    ...
    <h2>3. Mire használhatók a „sütik”?</h2>
    ...
    <h2>4. Milyen „sütikkel” találkozhat?</h2>
    ...
    <p>Harmadik féltől származó „sütik”, melyeket harmadik fél helyez el az Ön böngészőjében (pl. Google Analitika). Ezek abban az esetben kerülnek a böngészőjében elhelyezésre, ha a meglátogatott weboldal használja a harmadik fél által nyújtott szolgáltatásokat.</p>
    <h5>Elengedhetetlen munkamenet (session-id) „sütik”:</h5>
    ...
    <h5>Analitikai vagy teljesítményfigyelő „sütik”:</h5>
    ...
    <h5>Célzott vagy reklám „sütik”:</h5>
    ...
    <h2>5. Tartalmaznak a „sütik” személyes adatokat?</h2>
    ...
    <h2>6. Miért fontosak a „sütik” az interneten?</h2>
    ...
    <h2>7. Biztonsággal és adatbiztonsággal kapcsolatos tényezők.</h2>
    ...
    <h2>8. A „sütik” kezelése, törlése</h2>
    ...
    <p>A beállítási lehetőségek általában a böngésző „Opciók” vagy „Beállítások” menüpontjában találhatók. Mindegyik webes kereső különböző, így a megfelelő beállításokhoz kérjük. használja keresője “Segítség” menüjét, illetve az alábbi linkeket a sütik beállításainak módosításához:</p>
    <ul>
        <li><a target="_blank" href="https://support.microsoft.com/hu-hu/help/17442/windows-internet-explorer-delete-manage-cookies">Cookie settings in Internet Explorer</a></li>
        <li><a target="_blank" href="https://support.mozilla.org/hu/kb/weboldalak-szerint-sutik-blokkolva-vannak-feloldas#w_check-cookie-settings">Cookie settings in Firefox</a></li>
        <li><a target="_blank" href="https://support.google.com/chrome/answer/95647?co=GENIE.Platform%3DDesktop&amp;hl=hu">Cookie settings in Chrome</a></li>
        <li><a target="_blank" href="https://support.apple.com/hu-hu/guide/safari/sfri11471/mac">Cookie settings in Safari</a></li>
    </ul>
    <p>Az anonim Google Analitika „sütik” kikapcsolásához egy úgynevezett „Google Analytics plug-in”-t (kiegészítőt) telepíthet a böngészőjébe, mely megakadályozza, hogy a honlap az Önre vonatkozó információkat küldjön a Google Analitikának. Ezzel kapcsolatban további információkat az alábbi linkeken talál:</p>
    <ul>
        <li><a target="_blank" href="https://policies.google.com/privacy?hl=hu">Google Analytics &amp; Privacy</a></li>
        <li><a target="_blank" href="https://safety.google/intl/hu/principles/">Google Elvek és Irányelvek</a></li>
    </ul>
